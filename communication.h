...
public:
	...
	void send_A_and_b_to_server1(const Matrix<Ciphertext> &A, const PackedMatrixSet<Ciphertext> &A_simd, const std::vector<Ciphertext> &b) { _server1.receive_fraction_of_A_and_b(A, A_simd, b); }
	...
	void send_Aprime_and_bprime_to_server2(const Matrix<Ciphertext> &A, const PackedMatrix<Ciphertext> &A_simd, const std::vector<Ciphertext> &b) { _server2.receive_A_and_bfrom_server1(A, A_simd, b); }
